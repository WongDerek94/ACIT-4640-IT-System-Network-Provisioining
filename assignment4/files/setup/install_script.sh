...
#     1. install the required packages to run the application
#     2. creates the user to run the application
#     3. retrieves the application code
...
preload_database () {
  export LANG=C
  mongorestore -d "${DATABASE_NAME}" "${SETUP_DIR}/preload-db"
}
